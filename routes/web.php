...
Route::get('/asma-ul-husna', function (App\AsmaulHusna $ism) {
    Seo::set('title', '99 Beautiful names of Allah');
    Seo::set('description', "Asma means names, and husna means beautiful. Thus asma al husna means the beautiful names of Allah Subhanah");
    $names = $ism->all();
...
Route::get('/dua.php', function (App\Dua $dua) {
    ...
    Seo::set('title', 'Islamic duas');
    Seo::set('description', "Islamic Duas for our Childrens and Parents");

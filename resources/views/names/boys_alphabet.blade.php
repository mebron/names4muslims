...
<div class="row border mb-2 shadow-sm">
    <div class="col-2 col-md-1 vertical-align position-relative bg-boy">
      <a class="text-boy stretched-link" href="#" data-toggle="modal" data-target="#exampleModalCenter"><h3 class="p-0">{{ $name->name[0] }}</h3></a></div>

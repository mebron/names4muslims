...
@endif
<div class="card">
<div class="card-header bg-info text-white"><h2 class="text-xs-center">Most Popular Muslim Names</h2></div>
<div class="card-body">
...
<div class="row border mb-2 shadow-sm">
  <div class="col-1 vertical-align text-white position-relative {{ $name->names->gender === "Boy" ? "bg-boy" : "bg-girl" }}">
    <a class="text-dark stretched-link" href="{{ url('/name',$name->names->slug)}}.html">{{ $name->names->name[0] }}</a></div>

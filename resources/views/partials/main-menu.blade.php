...
<li class="nav-item"><a class="nav-link btn-circle btn btn-md btn-pink py-2" data-toggle="modal" data-target="#searchForm" style="margin-bottom: -4px"> <i class="fa fa-search" aria-hidden="true"></i></a></li>

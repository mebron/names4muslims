 ...
 <div class="card">
  <div class="card-header"><h1>Add New Names</h1></div>
   <div class="card-body">
    <form method="post">
    {!! csrf_field() !!}
     ...
     <div class="form-group ">
      ...
      <textarea class="form-control" cols="40" id="meta_description" name="meta_description" placeholder="Meta Description" rows="10"></textarea>
     </div>
     <div class="form-group">
      <div>
